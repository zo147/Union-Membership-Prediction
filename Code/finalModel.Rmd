...
correlation_matrix <- function(data) {
  ...
  selected_df <- numeric_data[, c("age", "employment_stat", "wage_per_hour", "working_week_per_year", "industry_code", "occupation_code", "total_employed")]
...
predictions <- as.factor(predictions > 0.4)
